...
Shader "DroidekaShieldShader"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float temp_output_129_0 = sin( ( ( temp_output_81_0 * _WaveFrequency ) - ( age115 * _WaveSpeed ) ) );
			float MaxDeformVar131 = _MaxDeform;
			float temp_output_124_0 = ( sin( ( age115 * UNITY_PI ) ) * smoothstepResult116 * temp_output_129_0 * MaxDeformVar131 );
			float3 ase_vertexNormal = v.normal.xyz;
			float simplePerlin2D71 = snoise( ( v.texcoord.xy + ( _Time.y * float2( 0.1,0 ) ) )*15.0 );
			simplePerlin2D71 = simplePerlin2D71*0.5 + 0.5;
			v.vertex.xyz += ( ( temp_output_124_0 * ase_vertexNormal ) + ( ase_vertexNormal * (_MinDeform + (simplePerlin2D71 - -1.0) * (_MaxDeform - _MinDeform) / (1.0 - -1.0)) ) );
			v.vertex.w = 1;
		}
...
/*ASEBEGIN
Version=18900
395;73;1209;515;3439.56;-2927.225;1.808362;True;False
...
Node;AmplifyShaderEditor.Vector3Node;83;-3005.16,2406.028;Inherit;False;Property;_HitShield;HitShield;9;0;Create;True;0;0;0;False;0;False;0,0,0;-0.2529016,0,-0.3931968;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.PosVertexDataNode;82;-3018.194,2237.785;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;90;-2055.239,411.8331;Inherit;True;Property;_TextureSample0;Texture Sample 0;3;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;133;-1672.487,2548.833;Inherit;False;131;MaxDeformVar;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;124;-1783.843,2213.182;Inherit;False;4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCRemapNode;72;-2060.719,3308.56;Inherit;True;5;0;FLOAT;0;False;1;FLOAT;-1;False;2;FLOAT;1;False;3;FLOAT;0.01;False;4;FLOAT;0.025;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;132;-1353.643,1950.636;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;130;-1540.718,2116.672;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
WireConnection;124;2;129;0
WireConnection;124;3;133;0
...
ASEEND*/
//CHKSM=B8AD6643A4E4BF98084FCF38C56D2DF44FD310C3