...
Shader "proyectorMaterial"
{
	Properties
	{
		_Color0("Color 0", Color) = (0.9990196,1,0.75,1)
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float mulTime49 = _Time.y * _linearSpeed;
			v.vertex.xyz += ( (0.0 + (sin( ( ( 1.0 - ( v.texcoord.xy.y * _Frequency ) ) + mulTime49 ) ) - -1.0) * (1.0 - 0.0) / (1.0 - -1.0)) * _amplitude * _Vector0 * ( 1.0 - v.texcoord.xy.y ) );
			v.vertex.w = 1;
		}
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 smoothstepResult74 = smoothstep( temp_cast_0 , temp_cast_1 , tex2D( _TextureSample0, uv_TextureSample0 ));
			o.Emission = ( _Color0 * smoothstepResult74 ).rgb;
...
/*ASEBEGIN
Version=18900
292;73;1139;627;1363.777;330.5805;1.260094;True;False
Node;AmplifyShaderEditor.RangedFloatNode;54;-1627.582,654.974;Inherit;False;Property;_Frequency;Frequency;1;0;Create;True;0;0;0;False;0;False;1;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;48;-1373.397,712.5418;Inherit;False;Property;_linearSpeed;linearSpeed;3;0;Create;True;0;0;0;False;0;False;1;0.3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;5;-1228.571,-47.59914;Inherit;True;Property;_TextureSample0;Texture Sample 0;2;0;Create;True;0;0;0;False;0;False;-1;bf74fb9c03ee4934389f2e0d8231f3bc;655c2528318d9a041bb8ed950c7246fc;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;66;-880.3259,817.6454;Inherit;False;Property;_amplitude;amplitude;4;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;2;-927.4197,-319.6996;Inherit;False;Property;_Color0;Color 0;0;0;Create;True;0;0;0;False;0;False;0.9990196,1,0.75,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector3Node;72;-651.2445,636.1612;Inherit;False;Property;_Vector0;Vector 0;5;0;Create;True;0;0;0;False;0;False;0,1,0;0,1,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
ASEEND*/
//CHKSM=C0C10E4C21E47EDCD6CD408C7254302E51F19202