...
Shader "PortalEffect_Shader"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Albedo = ( ( _BackgroundColor * tex2D( _Albedo, ( float4( ( float3( ( _Scale / _Divide ) ,  0.0 ) * (ase_worldPos).xyz ) , 0.0 ) + appendResult44 ).xy ) ) + ( lerpResult101 * _FresnelColor ) ).rgb;
			o.Alpha = _Opacity;
		}
...
/*ASEBEGIN
Version=18900
372;73;1199;698;213.3375;26.99007;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;95;-1531.172,735.4896;Inherit;False;Property;_Bias_Fresnel;Bias_Fresnel;2;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;38;-1546.912,2.964555;Inherit;False;Property;_Scale;Scale;3;0;Create;True;0;0;0;False;0;False;20,20;40,40;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.WorldPosInputsNode;36;-1553.677,255.3988;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;39;-1535.187,146.3434;Inherit;False;Property;_Divide;Divide;7;0;Create;True;0;0;0;False;0;False;10;10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ComponentMaskNode;37;-1298.638,250.4306;Inherit;False;True;True;True;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleDivideOpNode;40;-1290.187,53.34356;Inherit;False;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;41;-1046.179,53.34356;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;45;-795.4788,100.7051;Inherit;True;2;2;0;FLOAT3;0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
ASEEND*/
//CHKSM=5CF61C921505E10ACD46CA58B99BB30DD45F9AA3